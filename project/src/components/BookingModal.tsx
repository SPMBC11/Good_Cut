...
const BookingModal: React.FC<BookingModalProps> = ({ isOpen, onClose, selectedBarber }) => {
  ...
  console.log('BookingModal render:', { isOpen, barbers: barbers.length, step });
  ...
  const handleSubmit = async () => {
    ...
    // Obtener datos del barbero y servicio
...
¡Gracias!`;
    ...
    const whatsappNumber = "573053113534"; // Reemplaza con tu número real
